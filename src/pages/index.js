    ...
    <main>
      <Layout pageTitle="Home">
        <div className={homeInfoContainer}>
          <div>
            <p>안녕하세요. 디자인 경력이 있는 클라이언트 개발자 정나래 입니다. 👋 <br />저는 약 4년간의 웹디자이너 경력이 있습니다. <br /> 디자이너로써 일을 하면서 html, css 유지보수를 맡아서 진행했습니다. <br />간단하게나마 코딩을 접하고나니 코딩의 매력에 푹 빠져버려서 무작정 개발자가 되고싶었습니다. </p>
            <br />
